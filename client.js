...
socket.on("waitingForJoining", () => {
    console.log(chalk.blueBright("Wait for the oppenent to joion!!............."));
});
...
socket.on("startGame", ({ symbol, player }) => {
    ...
    symbol === "X"
        ? console.log(chalk.yellow("Its your turn: Enter the numbr shown on the board."))
        : console.log(
            chalk.cyanBright.inverse("Its Openent turn: Wait for your turn...")
        );
});
